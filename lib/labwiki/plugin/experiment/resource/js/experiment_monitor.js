...
// calls the method 'loginR' from the config.ru
...
//calls the method getSetCookie from config.ru to login the user to get the cookie from the server
//and then calls with that cookie the method client_init
...
//tries to login the user but not working.. 
...
//http request to the RStudio Server to initliaze the client (not working..)
